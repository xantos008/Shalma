...
function Table({ columns, data }) {
  ...
  return (
     ...
     <Container>
     <Row>
     <Card className="border-0 card p-4">
	<div className="allTable">
		...
		<div className="pagination">
			...
			<div className="paginationActions">
				<button className="forwardPrev" onClick={() => gotoPage(0)} disabled={!canPreviousPage}>
				  {'<<'}
				</button>{' '}
				...
				<button className="forwardNext" onClick={() => gotoPage(pageCount - 1)} disabled={!canNextPage}>
				  {'>>'}
				</button>{' '}
			</div>
